                ...
                <img className="w-full object-cover mb-6" src='logoblack.svg' alt="Service" />
                    ...
                    <form className="mb-4 mt-5 flex flex-col" action="/" method="post" onSubmit={login}>
                        <div className="mb-4">
                            ...
                            <input className="w-full border rounded p-2 outline-none focus:shadow-outline" type="email" name="email" id="email" placeholder="Correo electrónico" value={email} onChange={handleemailChange}/>
                        </div>
                        <div className="mb-6">
                            <label htmlFor="password" className="block text-s mb-1">Contraseña</label>
                            <input className="w-full border rounded p-2 outline-none focus:shadow-outline" type="password" name="password" id="password" placeholder="Contraseña" value={password} onChange={handlePasswordChange} />
                        </div>
