  ...
  return (
    <main className="w-full">
      <section className="px-12 w-4/4 relative grid h-[33.5rem] grid-rows-2 ">
        <h1 className="ciberseguridad row-start-1 text-white ml-10">
          01 <br />
          CIBERSEGURIDAD
        </h1>
        <p className="row-start-2 self-center text-3xl ml-10 text-white/75">
          Mejora tu ciberseguridad, inteligencia y caza de amenazas
        </p>
        <div className="row-start-3 justify-self-center w-60">
          ...
          <p className="font-extralight text-white tracking-wider w-64">
            Líderes en protección a más de 100 empresas nacionales e
            internacionales.
          </p>
        </div>
      </section>
